...
api_key='AIzaSyBAOEIMnMox4iUsqw-8zKB90Vi3VuvNb9A' #your api key
...
eta = psycopg2.connect(host='localhost', port='5432', database='balads', user='postgres', password='bala5302#')
cursor=eta.cursor()
...
omega=pymongo.MongoClient("mongodb+srv://iam_bala_v:bala5302@cluster0.w1hodeu.mongodb.net/?retryWrites=true&w=majority")#enter the connection link from mongodb
